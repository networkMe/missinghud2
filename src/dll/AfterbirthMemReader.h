...
#define AB_PLAYER_MANAGER_FLOOR_FLAGS 0x7090
#define AB_PLAYER_MANAGER_FLOOR_BOSS_FIGHT 0x7018
#define AB_PLAYER_MANAGER_ROOM_CODE 0x701C
#define AB_PLAYER_MANAGER_ROOM_CODE_FORMULA_OFFSET 0x6D40
#define AB_PLAYER_MANAGER_BOSS_ROOM_CODE 0x7024
#define AB_PLAYER_MANAGER_DEAL_PREV_FLOOR 0x174D94
#define AB_PLAYER_MANAGER_AMOUNT_DONATED 0x174DAC
#define AB_PLAYER_MANAGER_SEEN_DEVIL 0x174D88
#define AB_PLAYER_MANAGER_PAID_DEVIL 0x174DA4
#define AB_PLAYER_MANAGER_YOU_FEEL_BLESSED 0x700C
